const FK_MAP = {
  ...
  capacidadcargatraccion: "capacidadcargatraccion",
  alcance: "alcance",
  cobertura: "cobertura",
  alcancecobertura: "alcancecobertura",
  medidas: "medidas",
  color: "color",
  divisionescajonesbandejas: "divisionescajonesbandejas",
  chapa: "chapa",
  abatible: "abatible",
  ...
  potencia: "potencia",
  horometro: "horometro",
  combustibleenergia: "combustibleenergia",
  funcion: "funcion",
  categoria: "categoria",
  caracteristicas: "caracteristicas",
  estadoinventario: "estadoinventario",
  estadoconservacion: "estadoconservacion",
  aprobadorinventario: "aprobadorinventario",
